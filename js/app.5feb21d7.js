(function(e) {
	...
	"56d7": function(e, t, n) {
		...
		Sa = Object(a["g"])("a", {
			href: "https://github.com/ContractChecker/SAFU/blob/main/PacMate_0x169BD8C47611aA06a46972bDe5ce36f568832c60_SAFU_Certificate_By_ContractChecker.pdf",
			class: "is-flex tag is-small mr-2",
			target: "_blank",
			rel: "noopener nofollow noreferrer",
			style: {
				"background-color": "rgb(223, 95, 248)",
		...
		function H(e, t, n, s, i, r) {
			...
			null, 8, w)])]), Object(a["g"])("div", k, [Object(a["g"])("div", x, [Object(a["g"])("div", C, [Object(a["g"])("div", T, [Object(a["g"])("h1", M, Object(a["A"])(e.presaleData.title), 1), Sa, A, S, Object(a["g"])("div", B, [Object(a["g"])("span", {
				...
				getData: function() {
					...
					fetch("https://api.pinksalae.finance/api/pinkProject/findProjectById_2?id=".concat(t)).then((function(e) {
						...
						if (t = JSON.parse(t), 1 === t.code) {
							...
							document.title = "".concat(e.presaleData.title, " - How to Buy ", e.presaleData.tokenSymbol).concat(e.presaleData.tokenDescription)
